...
12. Verify everything looks good at [quay](https://quay.io/repository/mjording/oauth2-proxy?tag=latest&tab=tags) and [github](https://github.com/mjording/oauth2-proxy/releases)
